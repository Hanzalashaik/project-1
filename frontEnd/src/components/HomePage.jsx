      ...
      <div>
              ...
              <Element name="text-section">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-700 text-lg mb-6 animate__animated">
                    Join us in making a difference! Our mission is to provide
                    vital humanitarian aid to the people of Palestine who are
                    enduring the devastating consequences of war. As the
                    conflict in the region persists, the need for assistance is
                    greater than ever. Your generous donations can help
                    alleviate their suffering and bring hope to those affected.
                  </p>
            ...
            <div className="w-full md:w-1/2">
              <Element name="text-section">
                <div className="text-center md:text-left ml-10">
                  ...
                  <p className="text-gray-700 text-lg mb-6 animate__animated">
                    Our organization is dedicated to delivering essential aid,
                    including food, clean water, medical supplies, and shelter
                    to the Palestinian families facing the harsh realities of
                    conflict. We work tirelessly to ensure that your
                    contributions reach those in need promptly and efficiently.
                    By supporting our efforts, you become a beacon of hope in
                    the lives of those who have endured immense hardship.
                  </p>
                  <div className="border-t border-gray-300 w-1/2 mb-6"></div>
                  <button className="px-6 py-2 bg-blue-500 rounded-full hover:bg-blue-600 text-white text-lg font-medium transition duration-300">
                    Learn More
            ...
            <div className="w-full md:w-1/2">
              <Element name="text-section">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-700 text-lg mb-6 animate__animated">
                    With your support, we aim to not only provide immediate
                    relief but also to work towards a brighter future for the
                    people of Palestine. Education, healthcare, and sustainable
                    development projects are integral parts of our long-term
                    vision. Your donations enable us to invest in the well-being
                    and resilience of the community, fostering a sense of
                    stability and hope.
                  </p>
                  <div className="border-t border-gray-300 w-1/2 mb-6"></div>
                  <button className="px-6 py-2 bg-blue-500 rounded-full hover:bg-blue-600 text-white text-lg font-medium transition duration-300">
            ...
            <div className="w-full md:w-1/2">
              <Element name="text-section">
                <div className="text-center md:text-left ml-10">
                  ...
                  <p className="text-gray-700 text-lg mb-6 animate__animated">
                    By standing with us, you stand with the people of Palestine,
                    showing your solidarity and compassion. Your contributions,
                    whether large or small, make a significant impact in their
                    lives. Together, we can bring relief, healing, and a renewed
                    sense of dignity to those who have experienced immense
                    suffering. Join us in this noble cause and make a lasting
                    difference today.
                  </p>
                  <div className="border-t border-gray-300 w-1/2 mb-6"></div>
                  <button className="px-6 py-2 bg-blue-500 rounded-full hover:bg-blue-600 text-white text-lg font-medium transition duration-300">
        ...
        <div className="w-full h-[50%] flex flex-col justify-center items-center py-[55px] shadow-xl">
          <div className="w-[80%] h-[250px] md:h-[150px] bg-blue-600 flex flex-col md:flex-row justify-center items-center text-center rounded-xl mb-5">
            <h1 className="text-lg md:text-xl text-white md:pr-10 font-semibold">
